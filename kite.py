...
class KiteAICron:
    ...
    async def run_tasks_for_account(self, private_key: str, agent_lists: list):
        ...
        # Inisialisasi headers dan token
        self.TESTNET_HEADERS[address] = {"Origin": "https://testnet.gokite.ai", "Referer": "https://testnet.gokite.ai/"}
        self.MULTISIG_HEADERS[address] = {"Origin": "https://wallet.ash.center", "Referer": "https://wallet.ash.center/"}
